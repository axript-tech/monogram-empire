...
<div class="swiper-container hero-slider">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide relative h-screen">
            <video autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-cover opacity-100">
                <source src="assets/images/mono.mp4" type="video/mp4">
            </video>
            <div class="relative container mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
                ...
                <p class="text-lg md:text-xl text-brand-dark max-w-2xl mb-8">
        ...
        <div class="swiper-slide relative h-screen">
            <video autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-cover opacity-40">
                <source src="assets/images/Cossly.mp4" type="video/mp4">
            </video>
            <div class="relative container mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
                <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-4" style="font-family: 'Playfair Display', serif;">
                ...
                <a href="request-service.php" class="border-2 border-brand-gold text-brand-dark font-bold py-3 px-8 rounded-full text-lg hover:bg-brand-gold hover:text-brand-dark transition-colors">
        ...
        <!-- <div class="swiper-slide relative h-screen">
            <video autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-cover opacity-40">
                <source src="https://videos.pexels.com/video-files/854256/854256-hd_1920_1080_25fps.mp4" type="video/mp4">
            </video>
            <div class="relative container mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
                <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-4" style="font-family: 'Playfair Display', serif;">
